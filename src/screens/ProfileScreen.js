...
const styles = StyleSheet.create({
  ...
  loadingText: { color: '#14283D', fontWeight: '700', fontSize: 16 },
  ...
  cardTitle: { color: '#14283D', fontSize: 15, fontWeight: '800', marginBottom: 4 },
  shortcutRow: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingVertical: 14,
  ...
  shortcutLabel: { flex: 1, color: '#14283D', fontWeight: '700', fontSize: 14 },
  editLink: { color: '#0F8A72', fontWeight: '700', fontSize: 13 },
  ...
  pickerTitle: { fontSize: 16, fontWeight: '800', color: '#14283D', textAlign: 'center', marginBottom: 8 },
  ...
  tagText: { color: '#14283D', fontWeight: '700', fontSize: 13 },
  editHint: { color: '#5A6B68', fontSize: 12, marginBottom: 10, marginTop: 4 },
  ...
  subjectChipOn: { backgroundColor: '#0F8A72', borderColor: '#0F8A72' },
  subjectChipLocked: { opacity: 0.85 },
  subjectChipText: { color: '#14283D', fontWeight: '700', fontSize: 12 },
  ...
  noteGroupHeader: { fontSize: 13, fontWeight: '800', color: '#14283D' },
  noteRow: {
    backgroundColor: '#F3F7F5',
    borderRadius: 14,
    marginBottom: 8,
  ...
  noteTopic: { flex: 1, fontSize: 13, fontWeight: '800', color: '#14283D' },
  noteDate: { fontSize: 11, color: '#5A6B68' },
  noteChevron: { fontSize: 13, color: '#0F8A72', fontWeight: '700' },
  noteBody: {
    borderTopWidth: 1,
  ...
  mutedText: { color: '#5A6B68', fontSize: 13, lineHeight: 20, marginTop: 4 },
  ...
  logoutModalTitle: { fontSize: 16, fontWeight: '800', color: '#14283D', marginBottom: 14, textAlign: 'center' },
