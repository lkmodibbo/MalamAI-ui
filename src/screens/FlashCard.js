...
import { subjectInitials } from '../components/SubjectBadge';

export default function FlashCard({ card, subjectName, flipped, onFlip }) {
  ...
  return (
    <TouchableWithoutFeedback onPress={onFlip}>
      <View style={styles.cardWrapper}>
        <Text style={styles.watermark}>{subjectInitials(subjectName)}</Text>
